          ...
          <div className="row gx-5 gy-5">
            ...
            <div className="col-xl-3 col-lg-4">
              ...
              <nav className="list-group"><a className="list-group-item list-group-item-action d-flex justify-content-between align-items-center" href="customer-orders.html"><span className="fw-normal text-sm text-dark py-1">
                <p className="svg-icon me-2 svg-icon-sm svg-icon-heavy">
                  <use href="#shopping-bag-1"> </use>
                </p>Orders</span><small className="badge rounded-pill bg-primary">5</small></a><a className="active list-group-item list-group-item-action d-flex justify-content-between align-items-center rounded-0" href="customer-account.html" aria-current="true"><span className="fw-normal text-sm py-1">
                  <p className="svg-icon me-2 svg-icon-sm svg-icon-heavy">
                    <use href="#user-1"> </use>
                  </p>Profile</span></a><a className="list-group-item list-group-item-action d-flex justify-content-between align-items-center" href="/customer-addresses"><span className="fw-normal text-sm text-dark py-1">
                    <p className="svg-icon me-2 svg-icon-sm svg-icon-heavy">
                      <use href="#map-marker-1"> </use>
                    </p>Addresses</span></a><a className="list-group-item list-group-item-action d-flex justify-content-between align-items-center" href="customer-login.html"><span className="fw-normal text-sm text-dark py-1">
                      <p className="svg-icon me-2 svg-icon-sm svg-icon-heavy">
                        <use href="#key-1"> </use>
                      </p>Log out</span></a>
              </nav>
